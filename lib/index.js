...
exports.store = exports.PreMounter = exports.history = exports.BaseRouter = exports.combineXhrReducers = exports.attachState = exports.attachReducers = exports.reducers = exports.initialState = undefined;
...
function InitApp(opts) {
    ...
    exports.store = store = (0, _redux.createStore)((0, _connectedReactRouter.connectRouter)(_middleware.history)(reducer), _reducerManagement.initialState, _middleware.middleware);
